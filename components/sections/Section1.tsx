  ...
  return (
    <section className="section bg-accentPrimary">
      <div className="m-auto max-w-screen-2xl overflow-hidden px-6 md:px-10 lg:px-14">
        ...
        <h1 className="font-semibold text-textInverseHighlight leading-tight m-0 p-0 w-auto tracking-tight md:tracking-tighter z-10 text-center md:relative top-32 md:top-[72px] pt-12 md:p-0 text-5xl md:text-6xl lg:text-[118px]">
           Mortgages <br />
           made simple
        </h1>
